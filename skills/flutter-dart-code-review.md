...
Use when:
- reviewing Flutter or Dart pull requests,
- auditing code quality before release,
- checking architecture, performance, or state management decisions,
- verifying that a Flutter codebase follows maintainable conventions.
