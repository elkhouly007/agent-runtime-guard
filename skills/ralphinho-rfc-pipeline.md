...
Use when:
- a feature or refactor must be decomposed into multiple independently verifiable units,
- you need RFC-driven sequencing before implementation,
- work will be distributed across agents or parallel contributors,
- integration risk is high enough to require explicit dependency and merge planning.
