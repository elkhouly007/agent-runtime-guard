...
Use when:
- the user invokes a `/ck:*` command,
- project context must be initialized, refreshed, or queried,
- a workspace needs structured context persistence and retrieval,
- the operator wants the Context Keeper workflow rather than generic memory handling.
