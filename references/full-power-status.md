...
- executable fixture coverage with **116/116 passing**;
...
- `run-fixtures.sh` — passing (116/116)
...
> **Agent Runtime Guard is a purpose-built, all-original agentic policy and amplification framework with a verified runtime decisioning layer, comprehensive rule coverage across 12 languages, and 116 passing integration fixtures.**
