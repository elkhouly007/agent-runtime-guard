...
- executable fixture coverage with **104/104 passing**;
...
- `run-fixtures.sh` — passing (104/104)
...
> **Agent Runtime Guard is a purpose-built, all-original agentic policy and amplification framework with a verified runtime decisioning layer, comprehensive rule coverage across 12 languages, and 104 passing integration fixtures.**
